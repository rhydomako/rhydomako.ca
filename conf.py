...
BLOG_AUTHOR = "Richard Hydomako"  # (translatable)
BLOG_TITLE = "rhydomako.ca"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link
SITE_URL = "http://rhydomako.ca/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://getnikola.com/"
BLOG_EMAIL = "rhydomako (at) gmail.com"
BLOG_DESCRIPTION = "rhydomako blog"  # (translatable)
...
DEPLOY_COMMANDS = {
    'default': [
	'lftp -c "open '+os.getenv('FTPHOST','localhost')+'; set ftp:ssl-allow false; mirror -R output .; bye"',
    ]
}
